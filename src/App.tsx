...
export default function App() {
  ...
  const handleNewProject = () => {
    ...
    const blankFloorPlan: FloorPlanData = {
      ...
      columns: [
        { id: 'col_A1', gridXLabel: 'A', gridYLabel: '1', x: 0, y: 0, widthCm: 30, depthCm: 30, shape: 'rectangular', material: 'RC', condition: 'good' },
        ...
        { id: 'col_D1', gridXLabel: 'D', gridYLabel: '1', x: 12.0, y: 0, widthCm: 30, depthCm: 30, shape: 'rectangular', material: 'RC', condition: 'good' },

        { id: 'col_A2', gridXLabel: 'A', gridYLabel: '2', x: 0, y: 4.5, widthCm: 30, depthCm: 30, shape: 'rectangular', material: 'RC', condition: 'good' },
        { id: 'col_B2', gridXLabel: 'B', gridYLabel: '2', x: 4.0, y: 4.5, widthCm: 30, depthCm: 30, shape: 'rectangular', material: 'RC', condition: 'good' },
        { id: 'col_C2', gridXLabel: 'C', gridYLabel: '2', x: 8.0, y: 4.5, widthCm: 30, depthCm: 30, shape: 'rectangular', material: 'RC', condition: 'good' },
        ...
        { id: 'col_B3', gridXLabel: 'B', gridYLabel: '3', x: 4.0, y: 9.0, widthCm: 30, depthCm: 30, shape: 'rectangular', material: 'RC', condition: 'good' },
