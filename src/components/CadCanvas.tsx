    ...
    <div className="flex flex-col h-full bg-slate-900 text-slate-100 rounded-xl overflow-hidden border border-slate-800 shadow-2xl">
      ...
      <div id="cad-canvas-workspace" className="flex-1 flex flex-col sm:flex-row relative overflow-hidden bg-slate-950 h-full min-h-0">
        ...
        <div
          ...
          className="bg-slate-950 border-b sm:border-b-0 sm:border-r border-slate-800 p-1 flex sm:flex-col items-center gap-1 overflow-x-auto sm:overflow-y-auto shrink-0 z-20 shadow-lg sm:h-full sm:max-h-full"
        >
          <button
          ...
          <div className="w-full h-px bg-slate-800 my-0.5 hidden sm:block shrink-0" />
          ...
          <button
            ...
            title={
              selectedColId || selectedWallId || selectedOpeningId || selectedDefectId || selectedRoomId
                ? 'ลบรายการที่เลือกบนแปลน'
                : 'คลิกเลือกวัตถุบนแปลนก่อน แล้วกดปุ่มนี้เพื่อลบ'
            }
          >
        ...
        <div
          ...
          onMouseDown={(e) => e.stopPropagation()}
          style={{ touchAction: 'pan-y' }}
          className="w-full lg:w-80 bg-slate-900 border-t lg:border-t-0 lg:border-l border-slate-800 p-3 lg:p-4 flex flex-col gap-3 lg:gap-4 max-h-[350px] lg:max-h-full lg:h-full overflow-y-auto shrink-0"
        >
          {/* Header */}
